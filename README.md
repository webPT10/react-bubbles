...
- [ ] Explain what a token is used for.
  ...
  > A token is a unique identifier, similar to a password. Generally tokens are used for authorization to various routes, typically Protected Routes, in an app.

- [ ] What steps can you take in your web apps to keep your data secure?

  > Create protected and private Routes that require Authentication by the user.

- [ ] Describe how web servers work.

  > Computers connect to the Internet via the WWW, locate a specific computer through a URL/domain name and retrieve information/resources from that server.

- [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.

  > PUT is the "U" in CRUD --> to UPDATE
  > DELETE is the "D" in CRUS --> to DELETE
